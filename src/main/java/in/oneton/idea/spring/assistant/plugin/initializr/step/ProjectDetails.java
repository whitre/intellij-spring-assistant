...
public class ProjectDetails {
    ...
    public void init(InitializrModuleBuilder moduleBuilder, WizardContext wizardContext) {
        ...
        if (project != null && project.isInitialized()) {
            boolean rootProjectIsGradle = findFileUnderRootInModule(wizardContext.getProject().getBaseDir(), "build.gradle") != null;
            if (rootProjectIsGradle) {
                defaultProjectTypeId = "gradle-project";
            } else {
                boolean rootProjectIsMaven = findFileUnderRootInModule(wizardContext.getProject().getBaseDir(), "pom.xml") != null;
